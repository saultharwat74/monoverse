...
import { Mail, Lock, Eye, EyeOff, AlertCircle, Shield, Sparkles, ArrowRight } from 'lucide-react-native';
    ...
    <View style={styles.container}>
      ...
      <View style={styles.demoContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => handleDemoCredentials('admin@example.com', 'password123')}
        >
